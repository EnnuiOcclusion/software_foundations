...
Fixpoint bin_to_nat (n: bin) : nat :=
  ...
  | M Z => S O
  | M n' => S (bin_to_nat n')
  | T n' => S (S (bin_to_nat n'))
  end.

Example test_bin_incr1: bin_to_nat (incr Z) = S (bin_to_nat Z).
Proof. simpl. reflexivity. Qed.
Example test_bin_incr2: bin_to_nat (incr (M Z)) = S (bin_to_nat (M Z)).
Proof. simpl. reflexivity. Qed.
Example test_bin_incr3: bin_to_nat (incr (T Z)) = S (bin_to_nat (T Z)).
Proof. simpl. reflexivity. Qed.
Example test_bin_incr4: bin_to_nat (incr (M (T Z))) = S (bin_to_nat (M (T Z))).
Proof. simpl. reflexivity. Qed.
Example test_bin_incr5: bin_to_nat (incr (T (T Z))) = S (bin_to_nat (T (T Z))).
Proof. simpl. reflexivity. Qed.
